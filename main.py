...
dataset, args.n_feat, args.n_class, args.mapping = get_TUDataset(
...
class_train_num_graph = [int(args.imb_ratio * args.num_training),
                         args.num_training - int(args.imb_ratio * args.num_training)]
class_val_num_graph = [int(args.imb_ratio * args.num_val),
                       args.num_val - int(args.imb_ratio * args.num_val)]
...
for count in pbar:
    ...
    train_dataset, val_dataset, test_dataset, args.class_train_num_graph, args.class_val_num_graph = shuffle(
        args.dataset, dataset, class_train_num_graph, class_val_num_graph, y, args.seed + count)
