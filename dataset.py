...
class TUDataset(InMemoryDataset):
    ...
    def __init__(self, root: str, name: str,
        ...
        if not (self.name == 'MUTAG' or self.name == 'PTC_MR' or self.name == 'DD' or self.name == 'PROTEINS' or self.name == 'NCI1' or self.name == 'NCI109' or self.name == 'Mutagenicity' or self.name == 'DHFR'):
...
def get_TUDataset(dataset, pre_transform):
    ...
    dataset = TUDataset(path, name=dataset, pre_transform = pre_transform).shuffle()
...
def shuffle(dataname, dataset, class_train_num_graph, class_val_num_graph, y, seed):
